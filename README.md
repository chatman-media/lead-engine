...
- **A/B-тест в проде** — INSERT в таблицу `experiments` с весами вариантов
  (`{"flirty-v1": 50, "empathetic-v1": 50}`); каждый prospect детерминированно
  попадает в один вариант и больше не пересортировывается.

Подробности, схема БД, и план Phase 2b (админка) — [docs/SALES_STYLES.md](docs/SALES_STYLES.md).
