  ...
  stages: {
    ...
    qualify: {
      ...
      guidance:
        ...
        "ВАЖНО: после 2-3 турнов вопросов (когда у тебя есть базовая инфа — возраст, " +
        "город, готовность) — переходи к close: предложи конкретный следующий шаг " +
        "(анкета / фото / созвон). Не зависай в режиме «вопрос-ответ-вопрос».",
