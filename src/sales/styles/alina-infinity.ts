  ...
  stages: {
    ...
    pitch: {
      ...
      guidance:
        ...
        "АКТУАЛЬНЫЕ ВАКАНСИИ. Для зарплаты конкретной страны/города используй ТОЛЬКО " +
        "соответствующую вакансию из АКТУАЛЬНЫЕ ВАКАНСИИ — игнорируй суммы в юанях/вонах " +
        "из KB CONTEXT если они относятся к другой локации. Никогда не выдумывай ставки или условия. " +
