...
export const flirtyBelfort: Style = StyleSchema.parse({
  ...
  stages: {
    ...
    pitch: {
      ...
      guidance:
        "Опирайся ТОЛЬКО на факты из АКТУАЛЬНЫЕ ВАКАНСИИ. Для зарплаты конкретной страны " +
        "используй ТОЛЬКО ту вакансию — не смешивай суммы из разных локаций. Не выдумывай суммы и сроки. " +
