...
type WorkflowKey = "transfer" | "cleaning" | "massage" | "beauty" | "housing" | "custom";
...
> = {
  transfer: {
    ...
    fields: ["flight", "arrival_time", "pickup", "dropoff", "passengers", "luggage", "car_class"],
    stages: [
      {
  ...
  cleaning: {
    ...
    fields: ["address", "cleaning_type", "access", "rooms", "photos", "laundry", "deadline"],
    stages: [
      {
  ...
  beauty: {
    ...
    fields: ["service", "reference_photo", "area", "time_window", "specialist", "prepayment"],
    stages: [
      {
  ...
  housing: {
    ...
    fields: ["dates", "area", "bedrooms", "budget", "property_type", "deposit_terms"],
    stages: [
      {
  ...
  custom: {
    ...
    fields: ["context", "photos", "address", "urgency", "budget", "constraints", "decision_owner"],
    stages: [
      {
...
const COPY = {
  ...
  en: {
    ...
    fieldsLabel: "Fields",
    providerLabel: "Provider marketplace",
    providerTitle: "Provider is installed into catalog, AI knows fields and handoff",
    footer: {
...
export default function DemoServiceWorkflow({ workflowKey }: { workflowKey: WorkflowKey }) {
        ...
        <div className="container">
          <div className="workflow-step-row">
            {workflow.stages.map((stage, index) => (
              <div key={stage.owner + stage.title.en} className="workflow-step-card">
