...
const COPY = {
  ru: {
    ...
    boardSub:
      "Каждый клиент проходит путь от первого сообщения до выдачи THB. Бот ведёт, оператор подключается на выдаче.",
    dialogLabel: "Диалог",
    dialogTitle: "Бот ведёт клиента сам",
    dialogSub:
      "Уточняет актив и сеть, фиксирует курс, выдаёт реквизиты. Оператор подключается только на выдаче QR.",
    rateLabel: "Курсы",
    rateTitle: "Тир-курс-карта",
    rateSub:
      "Чем больше сумма — тем лучше курс. Бот всегда транслирует то, что задано здесь, и никогда не выдумывает курс.",
    rateAmt: "Сумма",
    rateRate: "Курс",
    rateDev: "К рынку",
    reqLabel: "Реквизиты",
    ...
    reqSub:
      "Настраиваются в панели. Бот выдаёт нужные реквизиты автоматически по выбранному способу.",
  ...
  en: {
    ...
    boardSub:
      "Every client moves from first message to THB payout. The bot leads; the operator steps in at payout.",
    dialogLabel: "Dialog",
    dialogTitle: "The bot leads the client on its own",
    dialogSub:
      "Clarifies asset and network, locks the rate, shares payment details. The operator only joins for the QR payout.",
    rateLabel: "Rates",
    rateTitle: "Tiered rate card",
    rateSub:
      "The bigger the amount, the better the rate. The bot always shows what's set here — and never invents a rate.",
    rateAmt: "Amount",
    rateRate: "Rate",
    rateDev: "vs market",
    ...
    reqSub:
      "Configured in the panel. The bot serves the right details automatically based on the chosen method.",
    ctaTitle: "Want the same panel for your exchange?",
    ctaSub:
      "Pricing on request. Contact us — we'll tailor it to your volume and connect it in a couple of days.",
...
const LEADS: Lead[] = [
  {
    ...
    dir: "USDT TRC20 → THB",
    amt: "฿16 600",
    note: { ru: "Спросил курс на 500 USDT", en: "Asked rate for 500 USDT" },
    time: "2м",
  },
  {
    phase: "capture",
    ...
    dir: "RUB Сбер → THB",
    amt: "—",
    note: { ru: "«Здравствуйте, меняете рубли?»", en: "“Hi, do you exchange rubles?”" },
    time: "5м",
  },
  {
    phase: "capture",
    ...
    dir: "BTC → THB",
    amt: "—",
    note: { ru: "«Привет, какой курс BTC?»", en: "“Hey, what's the BTC rate?”" },
    time: "11м",
  },
  {
    phase: "qualify",
    ...
    dir: "USDT BEP20 → THB",
    amt: "฿33 100",
    note: { ru: "Уточняем сеть и сумму", en: "Clarifying network & amount" },
    time: "8м",
  },
  {
    phase: "qualify",
    who: "@olga_v",
    dir: "RUB Тинькофф → THB",
    amt: "฿28 400",
    note: { ru: "Запрошен паспорт", en: "Passport requested" },
    time: "14м",
    tag: { ru: "KYC", en: "KYC" },
  },
  {
    ...
    dir: "USDT TRC20 → THB",
    amt: "฿49 800",
    note: { ru: "Курс 33.2 подтверждён", en: "Rate 33.2 confirmed" },
    time: "3м",
    tag: { ru: "Курс", en: "Rate" },
  },
  {
    ...
    dir: "ETH → THB",
    amt: "฿72 500",
    note: { ru: "Ждём подтверждения курса", en: "Awaiting rate confirm" },
    time: "20м",
  },
  {
    phase: "pay",
    ...
    dir: "USDT TRC20 → THB",
    amt: "฿16 600",
    note: { ru: "Прислал tx hash, проверяем", en: "Sent tx hash, verifying" },
    time: "1м",
    tag: { ru: "Пруф", en: "Proof" },
  },
  {
    phase: "pay",
    who: "@maria_l",
    dir: "RUB Сбер → THB",
    amt: "฿12 900",
    note: { ru: "Ожидаем перевод на карту", en: "Awaiting card transfer" },
    time: "6м",
  },
  {
    phase: "payout",
    ...
    dir: "USDT TRC20 → THB",
    amt: "฿24 300",
    note: { ru: "Оператор отправил ATM QR", en: "Operator sent ATM QR" },
    time: "сейчас",
    tag: { ru: "QR", en: "QR" },
  },
  {
    ...
    dir: "USDT TRC20 → THB",
    amt: "฿16 600",
    note: { ru: "THB снят в банкомате ✅", en: "THB withdrawn at ATM ✅" },
    time: "1ч",
    tag: { ru: "Готово", en: "Won" },
  },
  {
    phase: "done",
    who: "@artem_g",
    dir: "RUB Тинькофф → THB",
    amt: "฿41 000",
    note: { ru: "Сделка закрыта ✅", en: "Deal closed ✅" },
    time: "2ч",
    tag: { ru: "Готово", en: "Won" },
  },
];
...
const REQS: { label: L; value: string; sub: L; mono?: boolean }[] = [
  {
    ...
    value: "TJ9k…q4Fq2Xb",
    sub: { ru: "Приём крипты", en: "Crypto inbound" },
    mono: true,
  },
  {
    label: { ru: "Сбербанк", en: "Sberbank" },
    value: "2202 20•• •••• 7741",
    sub: { ru: "Иван И. · приём ₽", en: "Ivan I. · ₽ inbound" },
    mono: true,
  },
  {
  ...
  {
    label: { ru: "Bangkok Bank", en: "Bangkok Bank" },
    value: "Cardless QR",
    sub: { ru: "Выдача THB наличными", en: "THB cash payout" },
  },
];
