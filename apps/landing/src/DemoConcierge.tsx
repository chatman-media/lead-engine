...
const COPY = {
  ru: {
    ...
    notify: "AI создал 5 заявок из одного сообщения: transfer, cleaning, massage, beauty, housing",
  ...
  en: {
    ...
    notify: "AI created 5 requests from one message: transfer, cleaning, massage, beauty, housing",
        ...
        <div className="container">
          ...
          <div className="demo-service-strip">
            {SERVICE_STRIP.map((service) => (
              <a key={service.en} className="demo-service-pill" href={service.href}>
                {t(service, lang)}
              </a>
            ))}
          </div>
