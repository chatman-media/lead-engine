...
const COPY = {
  ru: {
    ...
    overviewTitle: ["Не один бот. ", "Разные операционные системы под разные бизнесы."],
    overviewSub:
  ...
  en: {
    ...
    overviewBadge: "Vertical demo library",
    overviewTitle: ["Not one bot. ", "Different operating systems for different businesses."],
    overviewSub:
    ...
    knowledgeLabel: "Knowledge + rules",
    knowledgeTitle: "The vertical knows documents, constraints and the next step",
    telegramLabel: "Client interface",
    telegramTitle: "The bot is only the interface. Workflow engine runs inside.",
    tagOverview: "all verticals",
    footer: {
...
export default function DemoVerticals({ verticalKey }: { verticalKey?: VerticalKey }) {
        ...
        <div className="container">
          ...
          <div className="vertical-stage-row">
            {vertical.stages.map((stage, index) => (
              <div key={`${stage.phase}-${stage.title.en}`} className="vertical-stage-card">
          ...
          <div className="vertical-demo-grid">
            ...
            <div className="vertical-overview-board">
              <div className="vertical-panel-head">
                ...
                <strong>{"capture -> qualify -> offer -> handoff -> won"}</strong>
              </div>
        ...
        <div className="container">
          ...
          <div className="vertical-special-grid">
            {SPECIAL_DEMOS.map((demo) => (
              <a key={demo.href} href={demo.href} className="vertical-special-card">
