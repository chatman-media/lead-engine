...
const COPY = {
  ru: {
    ...
    title: ["AI принимает заявки, ", "ведет сделки", " и зовет оператора только в нужный момент"],
    ...
    pricingNote: "Для пилота достаточно одного канала, базы знаний и простого workflow.",
    faqLabel: "FAQ",
  ...
  en: {
    ...
    title: ["AI captures requests, ", "runs deals", " and calls an operator only when needed"],
    ...
    handoffLabel: "Human-in-the-loop",
    handoffTitle: "An operator is present in every dialog, without doing the routine",
    handoffSub:
    ...
    pricingNote: "A pilot only needs one channel, a knowledge base and a simple workflow.",
    faqLabel: "FAQ",
...
const PLANS: Record<Lang, Plan[]> = {
  ru: [
    ...
    },
    {
      ...
      priceUnit: "/мес",
      popular: true,
      features: ["3 канала", "5 workflows", "Операторские handoff", "История сделок"],
      cta: "Подключить",
    },
    {
      name: "Custom",
      price: "Индивидуально",
      isCustom: true,
      features: ["Маркетплейс услуг", "Интеграции", "SLA и роли", "Помощь с запуском"],
      cta: "Обсудить",
    },
  ],
  en: [
    {
      ...
      price: "$0",
      priceUnit: "/mo",
      features: ["1 channel", "1 workflow", "50 conversations", "Knowledge base"],
      cta: "Start",
    },
    {
      name: "Growth",
      ...
      priceUnit: "/mo",
      popular: true,
      features: ["3 channels", "5 workflows", "Operator handoff", "Deal history"],
      cta: "Connect",
    },
    {
      name: "Custom",
      price: "Custom",
      isCustom: true,
      features: ["Service marketplace", "Integrations", "SLA and roles", "Launch support"],
      cta: "Discuss",
    },
  ],
};
        ...
        <div className="container">
          ...
          <div className="demo-service-strip">
            {SERVICE_STRIP.map((service) => (
              <a key={service.href} className="demo-service-pill" href={service.href}>
                {t(service, lang)}
              </a>
            ))}
          </div>
          ...
          <div className="demo-kpis">
            {KPIS.map((kpi) => (
              <div key={kpi.value} className="demo-kpi">
                ...
                {kpi.trend && <div className="demo-kpi-trend">↑ {kpi.trend}</div>}
              </div>
            ))}
          </div>
        </div>
                ...
                <div key={phase.key} className="demo-col">
                  ...
                  {cards.map((lead) => (
                    ...
                    >
                      ...
                      <div className="demo-card-amt">{t(lead.summary, lang)}</div>
