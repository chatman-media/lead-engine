...
export const efficientProcessor: Style = StyleSchema.parse({
  ...
  voice: {
    ...
    language: "ru",
    forbid: ["длинные объяснения", "эмоции", "слово «Здравствуйте»", "неопределённые ответы"],
  },
  framework: "SPIN",
  hooks: [
  ...
  stages: {
    ...
    qualify: {
      ...
      guidance:
        "Чёткие конкретные вопросы: гражданство, страна, тип визы, даты, английский. Один вопрос — один ответ.",
      maxTurns: 4,
    },
    pitch: {
