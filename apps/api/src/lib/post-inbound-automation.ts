...
import { extractInboundText, type ServiceCatalogRuntime } from "./service-catalog-runtime.ts";
...
export async function runPostInboundAutomation(input: PostInboundAutomationInput): Promise<void> {
