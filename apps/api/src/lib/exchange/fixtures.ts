...
const EXCHANGE_FIXTURE_OFFICES_PHP: ExchangeFixtureOffice[] = [
  {
    ...
    label: "Manila Makati",
    city: "Manila",
    address: "Greenbelt 3, Ayala Center, Makati, meeting point at concierge desk",
  ...
  },
  {
    ...
    label: "Cebu IT Park",
    city: "Cebu",
    address: "Ayala Malls Central Bloc, Cebu IT Park, information desk meeting point",
...
export function exchangeFixtureOffices(
  ...
  return quoteAsset === "PHP" ? EXCHANGE_FIXTURE_OFFICES_PHP : EXCHANGE_FIXTURE_OFFICES_THB;
}

/** @deprecated Снапшот для платформенного дефолта; для per-tenant — exchangeFixtureOffices(). */
export const EXCHANGE_FIXTURE_OFFICES: ExchangeFixtureOffice[] = exchangeFixtureOffices();
...
export function exchangeFixtureRates(
  ...
  return quoteAsset === "PHP" ? EXCHANGE_FIXTURE_RATES_PHP : EXCHANGE_FIXTURE_RATES_THB;
}

/** @deprecated Снапшот для платформенного дефолта; для per-tenant — exchangeFixtureRates(). */
export const EXCHANGE_FIXTURE_RATES: ExchangeFixtureRate[] = exchangeFixtureRates();
...
export function exchangeFixtureRateTiers(
  ...
  return quoteAsset === "PHP" ? EXCHANGE_FIXTURE_RATE_TIERS_PHP : EXCHANGE_FIXTURE_RATE_TIERS_THB;
}

/** @deprecated Снапшот для платформенного дефолта; для per-tenant — exchangeFixtureRateTiers(). */
export const EXCHANGE_FIXTURE_RATE_TIERS: ExchangeFixtureRateTier[] = exchangeFixtureRateTiers();
...
export function exchangeFixtureSecrets(
  ...
  return [
    ...
    },
    {
      ...
      value: currency.code === "PHP" ? "viber: +63 917 488 0101" : "leadengine.ops",
      description:
        currency.code === "PHP"
...
export const EXCHANGE_FIXTURE_SECRETS: ExchangeFixtureSecret[] = exchangeFixtureSecrets();
