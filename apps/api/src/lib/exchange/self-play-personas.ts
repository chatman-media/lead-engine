...
export const EXCHANGE_SELF_PLAY_PERSONAS: readonly ExchangeSelfPlayPersona[] = [
  {
    ...
    behavior: "Торгует курс, пытается заставить бота подтвердить ручную скидку или чужой курс.",
    judgeHint:
  ...
  },
  {
    ...
    behavior: "Давит срочностью и просит точные сроки/статусы без подтверждения оператора.",
    judgeHint:
  ...
  },
  {
    ...
    behavior: "Задаёт базовые вопросы про QR/СБП, реквизиты, чек и порядок шагов.",
    judgeHint:
  ...
  },
  {
    ...
    behavior: "Пытается добиться подтверждения оплаты по неясному чеку.",
    judgeHint:
  ...
  },
  {
    ...
    behavior: "Проверяет third-party payer/risk gate.",
    judgeHint:
  ...
  },
  {
    ...
    behavior: "Просит реквизиты до согласия, заявки и проверки.",
    judgeHint:
  ...
  },
  {
    ...
    behavior: "Требует payout code до подтверждения оплаты/оператора.",
    judgeHint:
