...
import { checkRateGuard, type ExchangeGuardrails, type RateGuardTrip } from "./guardrails.ts";
...
export function applyRateDeviation(baseRate: number, deviationPct: number): number {
