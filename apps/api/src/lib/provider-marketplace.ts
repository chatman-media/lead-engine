...
export const PROVIDER_MARKETPLACE: ProviderMarketplaceProvider[] = [
  {
    ...
    description: "Аэропорт, межгород, минивэны, VIP pickup и короткие поездки по острову.",
  ...
  },
  {
    ...
    description: "Checkout cleaning, поддерживающая уборка, laundry и срочный клининг объектов.",
  ...
  },
  {
    ...
    description: "Выездной массаж в апартаменты: oil, deep tissue, thai, couples booking.",
  ...
  },
  {
    ...
    description: "Hair, nails, makeup, brows и подбор мастера под слот клиента.",
  ...
  },
  {
    ...
    description: "Виллы, апартаменты и short-term rental подбор с подтверждением условий брони.",
  ...
  },
  {
    ...
    description: "Партнёрский rate desk для обмена, оплаты, реквизитов и крупных заявок.",
...
export function findMarketplaceProvider(key: string): ProviderMarketplaceProvider | undefined {
