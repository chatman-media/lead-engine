					...
					const query = tx
						...
						.where(
							and(
								...
								activeFunnel
									? eq(stageDefinitions.funnelId, activeFunnel.id)
									: undefined,
							),
						)
