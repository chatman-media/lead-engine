  ...
  scooter: [
    {
      ...
      autoAdvanceCondition: '{"type":"all_required_fields_filled"}',
      fields: [
        { slug: "bike_type", displayName: "Тип байка", fieldType: "select", required: true, aiExtractable: true, position: 0,
          optionsJson: '[{"value":"scooter_auto","label":"Скутер-автомат"},{"value":"scooter_manual","label":"Скутер-механика"},{"value":"motorbike_125","label":"Мотоцикл 125cc"},{"value":"motorbike_400","label":"Мотоцикл 400cc+"},{"value":"any","label":"Любой"}]' },
        { slug: "date_from", displayName: "Дата начала", fieldType: "date", required: true, aiExtractable: true, position: 1 },
        { slug: "date_to", displayName: "Дата окончания", fieldType: "date", required: true, aiExtractable: true, position: 2 },
        { slug: "has_license", displayName: "Водительские права", fieldType: "boolean", required: true, aiExtractable: true, hint: "категория A или A1", position: 3 },
        { slug: "delivery_needed", displayName: "Нужна доставка", fieldType: "boolean", required: false, aiExtractable: true, position: 4 },
        { slug: "delivery_address", displayName: "Адрес доставки", fieldType: "text", required: false, aiExtractable: true, position: 5 },
      ],
    },
    {
      ...
      guidance: "Сообщите стоимость аренды, размер депозита и способы оплаты. Напомните взять с собой паспорт и права при получении.",
      kind: "active",
      stageType: "interaction",
      position: 1,
      color: "#f59e0b",
      ...
      fields: [
        { slug: "daily_rate_thb", displayName: "Ставка в день (THB)", fieldType: "number", required: false, aiExtractable: false, position: 0 },
        { slug: "deposit_thb", displayName: "Депозит (THB)", fieldType: "number", required: false, aiExtractable: false, position: 1 },
        { slug: "bike_model", displayName: "Модель байка", fieldType: "text", required: false, aiExtractable: false, position: 2 },
      ],
    },
    {
      ...
      guidance: "Предоставьте реквизиты для оплаты. При получении подтверждения — отправьте инструкции по получению байка.",
      kind: "active",
      stageType: "external_approval",
      position: 2,
      color: "#8b5cf6",
      ...
      fields: [
        { slug: "deposit_paid", displayName: "Депозит оплачен", fieldType: "boolean", required: true, aiExtractable: false, position: 0 },
        { slug: "payment_method", displayName: "Способ оплаты", fieldType: "select", required: false, aiExtractable: false, position: 1,
          optionsJson: '[{"value":"cash","label":"Наличные"},{"value":"qr","label":"QR-код"},{"value":"transfer","label":"Перевод"}]' },
      ],
    },
    {
      slug: "active_rental",
      ...
      guidance: "Напомните о правилах эксплуатации и процедуре при аварии. Оставайтесь на связи. При просрочке возврата — уведомьте.",
      kind: "active",
      stageType: "waiting",
      position: 3,
      color: "#10b981",
      ...
      fields: [
        { slug: "pickup_date", displayName: "Дата выдачи", fieldType: "date", required: false, aiExtractable: false, position: 0 },
        { slug: "return_date_confirmed", displayName: "Подтверждённая дата возврата", fieldType: "date", required: false, aiExtractable: false, position: 1 },
        { slug: "mileage_start", displayName: "Пробег при выдаче (км)", fieldType: "number", required: false, aiExtractable: false, position: 2 },
      ],
    },
    {
      slug: "returned",
      ...
      nextStages: [],
      fields: [
        { slug: "return_condition", displayName: "Состояние при возврате", fieldType: "select", required: false, aiExtractable: false, position: 0,
          optionsJson: '[{"value":"good","label":"Без повреждений"},{"value":"minor","label":"Мелкие царапины"},{"value":"damaged","label":"Повреждения"}]' },
        { slug: "deposit_returned", displayName: "Депозит возвращён", fieldType: "boolean", required: false, aiExtractable: false, position: 1 },
      ],
    },
    {
      slug: "cancelled",
      ...
      nextStages: [],
      fields: [
        { slug: "cancellation_reason", displayName: "Причина отмены", fieldType: "textarea", required: false, aiExtractable: false, position: 0 },
      ],
    },
  ],
