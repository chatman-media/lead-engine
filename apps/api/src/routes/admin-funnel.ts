...
const SEED_TEMPLATES: Record<string, SeedStage[]> = {
  ...
  exchange: [
    ...
    },
    {
      ...
      color: "#f59e0b",
      staleTimeoutDays: 1,
      // KYC опционален → разрешён переход сразу в awaiting_payment.
    ...
    },
    {
      ...
      fields: [
        ...
        { slug: "verification_id", displayName: "ID верификации (CRM)", fieldType: "text", required: false, aiExtractable: false, hint: "Внутренний номер верифицированного клиента — проставляет оператор", position: 2 },
      ],
    },
    {
