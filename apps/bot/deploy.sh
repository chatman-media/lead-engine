...
#     bash /home/chatman/app/apps/bot/deploy.sh
#
# APP_DIR is the monorepo root; `bun install` and `bun run build:ui` are
# root workspace scripts that delegate into apps/*.
#
