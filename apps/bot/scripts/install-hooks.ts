...
// Hook sources live next to this script, so resolve them relative to the
// script's own location — robust regardless of where the monorepo sits.
const srcDir = resolve(import.meta.dir, "git-hooks");
