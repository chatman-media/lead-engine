...
export const EXCHANGE_INTAKE: QuestionnaireSchema = {
  ...
  fields: [
    ...
    {
      slug: "arrival_date",
      question: "Вы уже на Пхукете или только прилетаете? Если прилетаете — подскажите дату, можем организовать трансфер и Зелёный коридор.",
      kind: "text",
      required: false,
      hint: "Дата прилёта для предложения доп. услуг (трансфер, VIP).",
    },
  ],
};
