...
export const RECRUITMENT_VISA_INTERVIEW: readonly QuestionnaireField[] = [
  ...
  {
    slug: "family_name",
    question: "Family name — фамилия латиницей, как в загранпаспорте.",
    kind: "text",
    required: true,
  },
  {
    slug: "given_name",
    question: "Given name — имя латиницей, как в загранпаспорте.",
    kind: "text",
    required: true,
  },
  {
    slug: "date_of_birth",
    question: "Date of birth — дата рождения в формате yyyy-MM-dd.",
    kind: "date",
    required: true,
  },
  {
  ...
  {
    slug: "city_of_birth",
    question: "City of birth — город рождения (на английском).",
    kind: "text",
    required: true,
  },
  {
  ...
  {
    slug: "mobile_phone",
    question: "Mobile phone number — мобильный телефон.",
    kind: "phone",
    required: true,
  },
  ...
  {
    slug: "father_name",
    question: "Father — имя отца (на английском).",
    kind: "text",
    required: true,
  },
  {
    slug: "father_nationality",
    question: "Father — гражданство отца (на английском).",
    kind: "text",
    required: true,
  },
  {
  ...
  {
    slug: "mother_name",
    question: "Mother — имя матери (на английском).",
    kind: "text",
    required: true,
  },
  {
    slug: "mother_nationality",
    question: "Mother — гражданство матери (на английском).",
    kind: "text",
    required: true,
  },
  {
