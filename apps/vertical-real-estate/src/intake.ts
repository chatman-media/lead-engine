...
export const REAL_ESTATE_INTAKE: QuestionnaireSchema = {
  ...
  fields: [
    ...
    },
    {
      ...
      question: "Есть предпочтение по форме владения — freehold, leasehold или без разницы?",
      kind: "enum",
      required: false,
    ...
    {
      slug: "meeting_format",
      question: "Вы сейчас на месте и готовы к просмотру или удобнее онлайн-созвон/видеотур?",
      kind: "enum",
      required: false,
      options: ["Офлайн просмотр", "Онлайн созвон / видеотур", "Пока переписка"],
