...
export function buildSystemPrompt(
  ...
  const rules =
    ...
    `их на русский и ответь по сути; НЕ сваливайся на маркер только из-за языка ` +
    `источника. Имена собственные (города, офисы, банки) передавай как принято ` +
    `по-русски, не искажая. ` +
