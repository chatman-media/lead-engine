# @chatman-media/channel-web

[![npm version](https://img.shields.io/npm/v/@chatman-media/channel-web?logo=npm&color=22c55e)](https://www.npmjs.com/package/@chatman-media/channel-web)
...
WebSocket-based web-chat adapter — a text-only channel for in-browser clients. Implements the `ChannelAdapter` contract from `@chatman-media/channel-core`.
...
```bash
bun add @chatman-media/channel-web     # Bun
npm install @chatman-media/channel-web # npm / pnpm / yarn
```
