...
export class NotificationService {
	...
	private formatButtons(
		...
		if (event.eventType === "operator_handoff_required" && event.conversationId) {
			const baseRow: TgInlineKeyboardButton[] = [
				{
					text: "👁 Чат",
				...
				{
					text: "✋ Взять",
					callback_data: operatorActionCallbackData(
						"takeover",
